...
namespace Ex03.GarageLogic
{
    public class Truck : Vehicle
    {
        ...
        public Truck(string i_TruckVendor, string i_LicensePlate, string i_WheelsVendor, float i_MaxAirPressure, float i_CurrentAirPressure, eEngineType i_EngineType, float i_CurrentEnergy, float i_MaxEnergy, eFuelType? i_FuelType, bool i_IsIncludeHazrdousMaterials, float i_LuggageVolume)
