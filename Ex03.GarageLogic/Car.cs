...
namespace Ex03.GarageLogic
{
    public class Car : Vehicle
    {
        ...
        public Car(string i_CarVendor, string i_LicensePlate, string i_WheelsVendor, float i_MaxAirPressure, float i_CurrentAirPressure, eEngineType i_EngineType, float i_CurrentEnergy, float i_MaxEnergy, eFuelType? i_FuelType, eCarColor i_CarColor, eNumOfCarDoors i_NumOfDoors)
